      ...
      <div className="a4-page relative flex flex-col p-4 print:p-2">
        ...
        <div className="flex flex-col mb-4 bg-muted/20 print:bg-transparent rounded-xl p-4 print:p-0 border border-border print:border-none gap-4 min-h-[170px] print:min-h-0">
          ...
          <div className="flex justify-between items-start w-full gap-4 print:items-end">
            ...
            {/* Memo No and Date Block (Screen) */}
            <div className="flex items-start gap-3 shrink-0 print:hidden">
              <div className="flex flex-col bg-background border border-border rounded-lg px-4 py-2 shadow-sm min-w-[120px]">
            ...
            {/* Memo No and Date Block (Print perfectly aligned to MRP and Amount) */}
            <div className="hidden print:flex shrink-0 w-[27%]">
               <div className="w-[44.4%] flex flex-col items-center">
                  <span className="text-[11px] font-bold text-slate-500 uppercase mb-0.5">Memo No.</span>
                  <span className="font-bold text-[13px] text-black">CSH-{memoNo.replace(/^CSH-/, '')}</span>
               </div>
               <div className="w-[55.5%] flex flex-col items-center">
                  <span className="text-[11px] font-bold text-slate-500 uppercase mb-0.5">Date</span>
                  <span className="font-bold text-[13px] text-black">{billDate.split('-').reverse().join('-')}</span>
               </div>
            </div>
          </div>
        </div>
